...
import 'package:paynuri_test/model/url_data.dart';
      ...
      */
      ...
      if (this.isAppLink()) {
        if (this.appScheme!.contains('intent')) {
          ...
          // scheme이 intent로 시작하면 뒷쪽의 정보를 통해 appscheme와 package 정보 추출
